...
/bin/su - web -c "export SECRET_KEY_BASE=64743aa516abe1515a648c793aded42023e6df199999ea4e3acac77f229fd5733cf248970323d82ae33734180b907d629a5030ea2679e383c3992571d0bb3ef1 &&\
                  cd /home/web/bankit &&\
                  /home/web/apps/ruby/bin/bundle install  --without test development
                  RAILS_ENV=production /home/web/apps/ruby/bin/rake db:migrate &&\
                  RAILS_ENV=production /home/web/apps/ruby/bin/rails server"
